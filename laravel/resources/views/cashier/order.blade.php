<x-cashier.layout>
    <x-cashier.navbar>
        ...
        <div id="bottom-sheet" class="fixed bottom-0 left-0 w-full bg-slate-50 shadow-lg transform translate-y-full transition-transform duration-300 rounded-t-2xl h-3/4">
