<nav class="bg-gray-800 fixed top-0 left-0 w-full z-50">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-26 items-center justify-between">
            <a href="{{ route('cashier.dashboard') }}" class="flex items-center space-x-2 sm:space-x-4">
                <img src="{{ asset('images/' . 'Logo.png') }}"
                     alt="Logo"
                     class="w-10 h-10 sm:w-12 sm:h-12">
                <p class="text-gray-300 text-lg sm:text-xl md:text-2xl font-bold hidden sm:block">TastyByte</p>
            </a>
